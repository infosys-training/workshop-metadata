...
Master inventory of all repositories in the [infosys-training](https://github.com/orgs/infosys-training/repositories) GitHub org.
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-legacy-modernization-cobol-to-java |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-legacy-modernization-oracle-forms-to-java |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-spring-boot-upgrade-microservice-extraction |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-cve-remediation-regulatory-compliance |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-data-source-migration-jdbc-normalization |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-dw-migration-teradata-to-snowflake |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-data-migration-sas-to-snowflake |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-data-migration-sas-to-databricks |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-data-migration-airflow |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-java-upgrade-broadleaf-commerce |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-product-analysis-loan-modernization |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-pod-remediation-credential-rotation |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-document-review-automation |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-bdd-test-generation-cucumber |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/uc-volume-anomaly-detection |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-informatica-powercenter |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-plsql-oracle-forms-hrms |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-angular-realworld |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-java-angular-jhipster |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-sas-legacy-analytics |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-java-selenium-testng |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-java-swagger-petstore |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-java-spring-boot-internet-banking |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-java-spring-boot-realworld |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/petclinic-rest-api |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/petclinic-angular |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/petclinic-backend |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/petclinic-microservices |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ordermanager-monolith |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ordermanager-iac |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ordermanager-microservices |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/eventflow-storefront |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/quickapp-monolith |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/quickapp-microservices |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/quickapp-microfrontends |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/quickapp-iac |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/timesheet-app |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/timesheet-infra |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/calcom |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/calcom-infra |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/calcom-dataeng |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-react-coreui-admin |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/ts-cobol-carddemo |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/jpetstore-6 |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/fineract |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/modular-monolith-ddd |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/platform-engineering-shared-services |
...
| | |
|---|---|
| **URL** | https://github.com/infosys-training/otterworks |
...
|------|-------------|-----------|
| [ts-python-aws-personalize](https://github.com/infosys-training/ts-python-aws-personalize) | AWS Personalize ML workshop | Python, AWS |
| [ts-angularjs-blur-admin](https://github.com/infosys-training/ts-angularjs-blur-admin) | AngularJS 1.x admin panel | AngularJS, Bootstrap |
| [ts-angularjs-dashboard-widgets](https://github.com/infosys-training/ts-angularjs-dashboard-widgets) | AngularJS dashboard widgets | AngularJS |
| [ts-informatica-powercenter](https://github.com/infosys-training/ts-informatica-powercenter) | Informatica PowerCenter 9.6.1 XML exports (11 mappings, 117K lines), Oracle SQL, shell orchestration — see [full entry](#ts-informatica-powercenter) | Informatica PowerCenter, Oracle, Shell |
| [ts-katalon-web-automation](https://github.com/infosys-training/ts-katalon-web-automation) | Katalon web automation sample | Katalon |
| [keycloak](https://github.com/infosys-training/keycloak) | Identity and Access Management | Java |
| [fineract-web-app](https://github.com/infosys-training/fineract-web-app) | Mifos X Web App (Fineract frontend) | Angular |
| [ofbiz-framework](https://github.com/infosys-training/ofbiz-framework) | Apache OFBiz ERP/CRM | Java |
| [openmrs-core](https://github.com/infosys-training/openmrs-core) | OpenMRS medical records | Java |
| [ts-java-real-estate-management](https://github.com/infosys-training/ts-java-real-estate-management) | Real estate property management | Java |
| [ruby-redmine](https://github.com/infosys-training/ruby-redmine) | Redmine project management | Ruby |
| [ts-serverless-digital-asset-payments](https://github.com/infosys-training/ts-serverless-digital-asset-payments) | Serverless digital asset payments | AWS, Serverless |
| [ts-serverless-eda-insurance-claims](https://github.com/infosys-training/ts-serverless-eda-insurance-claims) | Event-driven insurance claims | AWS, Serverless |
| [ts-python-streamify-data-engineering](https://github.com/infosys-training/ts-python-streamify-data-engineering) | Data engineering with Kafka, Spark, dbt | Python, Kafka, Spark, dbt |
| [traderx](https://github.com/infosys-training/traderx) | TraderX fork for Devin demos | Java |
